...
namespace Sakila.Models
{
    public partial class sakilaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySQL("Server=sakiladatabase.mysql.database.azure.com;database=sakila;User=areid;Password=" + System.Environment.GetEnvironmentVariable("SAKILA_PASSWORD"));
            }
        }
